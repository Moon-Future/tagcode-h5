...
<template>
  <article class="custom-detail">
    <header class="custom-hero">
      <img v-if="images[0]" :src="mediaUrl(apiBase, images[0])" :alt="name" @click="previewIndex = 0">
